...
services:
  proxmoxcenter:
    ...
    environment:
      ...
      PROXMOXCENTER_SELF_UPDATE_ENABLED: "${PROXMOXCENTER_SELF_UPDATE_ENABLED}"
      PROXMOXCENTER_SELF_UPDATE_INSTALL_DIR: "${PROXMOXCENTER_INSTALL_DIR}"
      PROXMOXCENTER_SELF_UPDATE_DATA_DIR: "${PROXMOXCENTER_DATA_DIR}"
      PROXMOXCENTER_SELF_UPDATE_BRANCH: "${PROXMOXCENTER_SELF_UPDATE_BRANCH}"
      PROXMOXCENTER_SELF_UPDATE_SERVICE: "${PROXMOXCENTER_SELF_UPDATE_SERVICE}"
      PROXMOXCENTER_SELF_UPDATE_RUNNER_IMAGE: "${PROXMOXCENTER_SELF_UPDATE_RUNNER_IMAGE}"
    volumes:
